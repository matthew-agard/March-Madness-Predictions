...
<br>All quotations were cited from the following article:
...
# TODO
-Structure API into nested directory
-Store notebooks in directories by year (easier to show progress year by year)
-Refactor various API components (feature engineering, data cleaning, pipelines)
